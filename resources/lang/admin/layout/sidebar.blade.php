   ...
   <ul class="side-menu app-sidebar3">
      ...
      <li class="slide">
         <a class="side-menu__item"  href="{{ route('callback') }}">
            ...
            <span class="side-menu__label"> Call Back Requests </span>
         </a>
      </li>
       <li class="slide">
      ...
      <li class="slide">
         <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pie-chart-fill side-menu__icon" viewBox="0 0 16 16">
               <path d="M15.985 8.5H8.207l-5.5 5.5a8 8 0 0 0 13.277-5.5zM2 13.292A8 8 0 0 1 7.5.015v7.778l-5.5 5.5zM8.5.015V7.5h7.485A8.001 8.001 0 0 0 8.5.015z"/>
            </svg>
            <span class="side-menu__label">{{__("message.Lab Components")}}</span><i class="angle fe fe-chevron-right"></i>
         </a>
         <ul class="slide-menu">
      ...
      <li class="slide is-expanded">
         <a class="side-menu__item" href="{{route('show-contact')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill side-menu__icon" viewBox="0 0 16 16">
      ...
      <li class="slide is-expanded">
         <a class="side-menu__item" href="{{route('send-news')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-newspaper side-menu__icon" viewBox="0 0 16 16">
      ...
      <li class="slide">
         <a class="side-menu__item"  href="{{url('setting/1')}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear side-menu__icon" viewBox="0 0 16 16">
