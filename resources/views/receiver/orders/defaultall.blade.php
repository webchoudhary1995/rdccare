      ...
      <div class="card">
         <div class="card-body">
            ...
            <div class="table-responsive">
               <table id="receiverallOrdersTable" class="table table-bordered text-nowrap dataTable no-footer">
                  <thead>
                     <tr>
                        <th>{{__("message.Id")}}</th>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div style="margin-bottom: 10px;" data-baseurl="{{ asset('storage/app/public/parcel/') }}">
                ...
                <img id="cargoImg" src="" alt="Dynamic Image">
...
<input type="hidden" id="uploadImageUrl" value="{{ url('receiver/parcel/mark-received') }}">
