                  ...
                  <div class="tab-content">
                     ...
                     <div class="tab-pane <?=isset($tab)&&$tab==3?'active':''?>" id="tab8">
                        <form action="{{route('save-package-test-info')}}" method="post" enctype="multipart/form-data">
                           ...
                           <input type="hidden" name="id" id="id" value="{{$id}}">
                           <div class="row">
                               <div class="col-6"><input id='add-row' class='btn btn-primary' type='button' value='{{__("message.Add Profile")}}' /> 
                            </div>
                               <div class="col-6">Total Price : <b id="total_price">0</b> - <b id="total_mrp">0</b></div>
                           </div>
