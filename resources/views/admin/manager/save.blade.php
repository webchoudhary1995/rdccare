		...
		<div class="card">
			...
			<div class="card-body">
				...
				@if(Session::has('message'))
             	...
             	@endif
			 	<form  action="{{route('update-manager-profile-admin')}}" method="post" enctype="multipart/form-data" class="row">
			 		{{csrf_field()}}
						...
						<input type="hidden" name="id" value="{{$id}}">
							...
							<div class="form-group col-6">
								...
								<input type="text" required class="form-control" id="email" name="phone" placeholder="{{__('message.Enter Phone')}}" value="{{isset($data->phone)?$data->phone:''}}">
							</div>
						...
						<?php $arr = array();
                                    ...
                                    ?>
     <!--             <div class="col-sm-12 col-md-12 parameter-hide" >-->
     <!--                 <div class="form-group">-->
