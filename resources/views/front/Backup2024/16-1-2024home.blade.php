...
<section class="process-style-two alternat-2 centred">
    ...
    <div class="auto-container">
        ...
        <div class="inner-content">
            ...
            <div class="brand-offers owl-carousel m-0">
...
<p><span>Includes : </span> {{$pl->no_of_parameter}} Parameters </p>
                    ...
                    <div class="btn-box row" style="display: flex;justify-content: center;">
...
<h4><span style="text-decoration: line-through;">{{$res_curr[1]}}{{number_format($pl->mrp,2,'.','')}}</span>
