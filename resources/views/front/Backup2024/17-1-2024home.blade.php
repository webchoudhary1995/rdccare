                  ...
                  <div class="pricing-table">
                    ...
                    <div class="table-footer"> 
                      ...
                      <h3><span
                                                    ...
                                                    style="text-decoration: line-through;">{{$res_curr[1]}}{{number_format($pl->mrp,2,'.','')}}</span> / {{$res_curr[1]}}{{number_format($pl->price,2,'.','')}} </h3>
                      <div class="btn-box"><a
              ...
              <div class="col-lg-12 col-md-6 col-sm-12 category-block">
                <div class="pricing-block-one">
                  <div class="pricing-table">
                    ...
                    <div class="table-footer">
                      <h4><span style="text-decoration: line-through;">{{$res_curr[1]}}{{number_format($pl->mrp,2,'.','')}}</span> / {{$res_curr[1]}}{{number_format($pl->price,2,'.','')}} </h4>
...
<!-- Blog section -->
<section class="blog_section sec-pad">
  <div class="auto-container">
    <div class="sec-title centred">
      <h2>Our Blogs</h2>
    </div>
      ...
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-3 col-12">
            	<div class="blog_box">
                	<div class="blog_img">
                    	<img src="https://rdccare.com/public/img/blog.png"/>
                    </div>
                    <div class="blog_content">
                        <p>Lorem Ipsum, sometimes referred to as 'lipsum', is the placeholder text...</p>
                        <div class="blog_link"><a class="read_more" href="#">Know More</a></div>
                        <div class="blog_bottom">
                        	<div class="author">Author Name</div>
                            <div class="blog_date">12 Jan 2024</div>
                        </div>
                    </div>
                </div>
          </div>
