   ...
   <div class="lower-content">
      <div class="auto-container">
         <ul class="bread-crumb clearfix">
            ...
            <li>{{isset($data->profile_name)?$data->profile_name:''}} 
            </li>
         </ul>
      </div>
   </div>
                             ...
                             <div class="col-12 row px-4 py-4">
                                 <div class="col-12 col-md-8 col-lg-8">
                                    <ul class="name-box clearfix col-12 mx-0 px-0">
                                       <li class="name">
                                          <h3 id="package_name" class="white">{{isset($data->profile_name)?$data->profile_name:''}} In {{ ucfirst($cityName)}}</h3>
                                       </li>
                                ...
                                <div class="col-12 col-md-4 col-lg-4 mt-1 row text-right-custom" >
                                   @if($data->price > 0)
                                       <!--<h6 class="mb-2 white">{{__('message.Healthians Price')}} :  <span style="text-decoration: line-through;font-weight:200;">{{$res_curr[1]}}{{$data->price}} </span>/ {{$res_curr[1]}}{{$data->mrp}} </h6>-->
                                        ...
                                        <div style="margin-top: 16px;"> 
                                            <a href="{{ route('checkouts', ['id' => $data->id, 'type' => 3, 'parameter' => $data->no_of_per ?? '0']) }}" 
                                          ...
                                          <div class="panel-heading" role="tab" id="headingOne">
                                             <span class="panel-title">
                                                <a role="button"  data-parent="#accordion" href="javascript:gotoparam('{{$td->slug}}')" aria-expanded="true" aria-controls="collapseOne">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-md-8"> {{$td->name}}</div>
                                                        <div class="col-md-4" style="text-align: right;">
                                                            <!--<span onclick="gotoparam('{{$td->slug}}');" style="cursor: pointer;">-->
                                                            <!--    <i class="fa fa-angle-down" style="color: white; font-size: 30px;"></i>-->
                                                            <!--</span>-->
                                                            <!--<button type="button" onclick="gotoparam('{{$td->slug}}');" class="view_btn"><b<i class="fa fa-angle-down mt-1" size="30"></i></button>-->
                                                        </div>
                                                   </div>
                                                </a>
                                             </span>
