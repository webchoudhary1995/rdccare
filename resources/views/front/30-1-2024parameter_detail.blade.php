...
<meta name="description" content="Book {{isset($data->name)?$data->name:''}} Online in {{$cityName}} with Free Sample Home Collection, Check {{isset($data->name)?$data->name:''}} Symptoms, Price">
...
<meta property="og:title" content="Book {{isset($data->name)?$data->name:''}} Test in {{$cityName}} | Reliable Diagnostic"/>
<meta property="og:image" content="{{asset('public/img/').'/'.$setting->logo}}"/>
<meta property="og:image:width" content="250px"/>
<meta property="og:image:height" content="250px"/>
<meta property="og:site_name" content="{{__('message.site_name')}}"/>
<meta property="og:description" content="Book {{isset($data->name)?$data->name:''}} Online in {{$cityName}} with Free Sample Home Collection, Check {{isset($data->name)?$data->name:''}} Symptoms, Price"/>
<meta property="og:keyword" content="{{isset($data->name)?$data->name:''}} in {{$cityName}}, {{isset($data->name)?$data->name:''}} symptoms, {{isset($data->name)?$data->name:''}} price"/>
...
<section class="page-title-two">
   <div class="title-box centred bg-color-2">
      ...
      <div class="auto-container">
         <div class="title">
            <h1>{{isset($data->name)?$data->name:''}} ({{isset($data->test_short_code)?$data->test_short_code  :''}}) {{__('message.Detail')}}</h1>
         </div>
      </div>
   </div>
   <div class="lower-content">
      <div class="auto-container">
         <ul class="bread-crumb clearfix">
            ...
            <li>{{isset($data->name)?$data->name:''}} ({{isset($data->test_short_code)?$data->test_short_code  :''}}) {{__('message.Detail')}}</li>
         </ul>
      </div>
   </div>
</section>
               ...
               <div class="clinic-block-one">
                  <div class="inner-box" style="padding: 34px 40px 37px 34px !important;">
                     <div class="content-box">
                        ...
                        @endif
                         <div class="middle body">
                           <div class="sm-container">
                              ...
                              <div class="sm-menu">
                                 <a href="https://www.facebook.com/sharer/sharer.php?u={{url('parameter-detail?id=').$data->id}}"><i class="fab fa-facebook-f"></i></a>
                                 <a href="https://web.whatsapp.com/send?url={{url('parameter-detail?id=').$data->id}}"><i class="fab fa-whatsapp"></i></a>
                                 <a href="https://twitter.com/intent/tweet?text={{$data->name}}&url={{url('parameter-detail?id=').$data->id}}"><i class="fab fa-twitter"></i></a>
                              </div>
                           </div>
                        </div>
                        <ul class="name-box clearfix">
                           <li class="name">
                              <h2>{{isset($data->name)?$data->name :''}} ({{isset($data->test_short_code)?$data->test_short_code  :''}}) In {{ ucfirst($cityName)}}</h2>
                           </li>
                           <li><i class="icon-Trust-1"></i></li>
                           <li><i class="icon-Trust-2"></i></li>
                        </ul>
                        <div class="text">
                           <p>{{__('message.Parameter Included')}}: 1</p>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <div class="rating-box clearfix">
                                 <ul class="rating clearfix">
                                    ...
                                    <li><a href="#">({{$data->total_review}})</a></li>
                                 </ul>
                              </div>
                           </div>
                           <div class="col-md-6">
                        ...
                        <div class="">
                           @if(Auth::id())                         
                                    <a href="javascript:void()" onclick="showmember('{{$data->id}}','{{$data->mrp}}','{{$data->price}}','1',3)"  data-toggle="modal" data-target="#addaddress" class="theme-btn-one">{{__('message.Book Now')}}<i class="icon-Arrow-Right"></i></a>
                           @else
