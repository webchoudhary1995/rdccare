                     ...
                     <div id="collapse3" class="panel-collapse collapse show" role="tabpanel" aria-labelledby="heading3">
                        <div class="panel-body">
                           <div class="row boxed" id="users_address_list">
                              ...
                              <label for="is_default_{{$ua->id}}"><p style="font-size:13px;">{{__('message.House no')}}: {{$ua->house_no}}<br> {{$ua->address}} <br>{{$ua->city}} {{$ua->state}} - {{$ua->pincode}}</p></label>
                           ...
                           <div class="team-block-three">
                              <div class="inner-box">
                                 <div class="lower-content">
                                    ...
                                    <?php
                                    if ($item['discount']['fixed'] > 0.00 ) {
                                        $per = $item['discount']['per'];
                                        $discount = $item['mrp'] - $item['discount']['fixed'];
                                    }else{
                                        $discount = $item['mrp'] ;
                                    }
                                    ...
                                    <div class="row" id="member_{{$item['id']}}" style="border-top: 1px solid white;">
                                       <div class="col-md-9">
                                          ...
                                          @if($item['discount']['fixed'] > 0.00 )
                                          <p><span style="text-decoration:line-through;color:#1e4169;"> {{$item['mrp']}}</span> |  {{  $discount}}</p></div>
                                          @else
                                          <p><span> {{$item['mrp']}}</span></p></div>
                                          @endif
                                       <?php 
                                       ...
                                       <div class="col-md-3" >
                                            ...
                                            <p style="margin-top: 8px;margin-bottom: 19px;">
                                              <span style="background: green;color: white;    padding: 2px;">{{round($per)}}%</span>
                                            </p>
                                            @endif
                                          <p><span></span></p>
