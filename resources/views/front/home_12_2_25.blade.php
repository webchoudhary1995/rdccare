                ...
                <div class="pricing-block-one">
                  <div class="pricing-table">
                    ...
                    <div class="table-header">
                      <h2><a href="{{ route('package', ['city'=>$cityName,'id' => $pl->slug ]) }}" style="text-decoration: none; color: inherit;">{{$pl->name}}</a></h2>
                  ...
                  @endforeach
                    ...
                    <div class="table-footer"> 
                        <div class="btn-box">
                          <a href="{{ route('checkouts', ['id' => $pl->id, 'type' => 1, 'parameter' => $pl->no_of_parameter ?? '0']) }}" class="book_now">{{__('message.Book Now')}}<i class="icon-Arrow-Right"></i></a>
                        </div>
                      
                      @if($pl->price > 0 )
                      <div><h3><span class="price">{{$res_curr[1]}}{{number_format($pl->price,2,'.','')}}</span> / <span class="discount_price">{{$res_curr[1]}}{{number_format($pl->mrp ,2,'.','')}}</span> </h3></div>
                      
                      @else
                      <div><h3><span class="discount_price">{{$res_curr[1]}}{{number_format($pl->mrp,2,'.','')}}</span></h3></div>
                      @endif
            ...
            <div class="col-lg-12 col-md-6 col-sm-12 category-block">
              <div class="category-block-one wow fadeInUp animated animated" data-wow-delay="00ms"
                ...
                <div class="inner-box">
                  ...
                  <!--<div class="link"><a href="{{ route('lifestyle-disorder',['city'=>$cityName]) }}"><i class="icon-Arrow-Right"></i></a></div>-->
                  <div class="btn-box mt-3"><a href="{{ route('lifestyledisorder', ['city'=>$cityName,'slug' => $c->slug]) }}"
                                            class="book_now mt-3">{{__('message.View List')}}<i class="icon-Arrow-Right"></i></a></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-12 col-md-6 col-sm-12 category-block">
                <div class="pricing-block-one">
                  <div class="pricing-table">
                    ...
                    <div class="table-header">
                      <h2><a href="{{ route('profile', ['city'=>$cityName,'id' => $pl->slug ]) }}" style="text-decoration: none; color: inherit;">{{$pl->profile_name}}</a></h2>
                    ...
                    <div class="table-content">
                      <ul class="list clearfix" id="parameterList">
                        ...
                        <li><span class="mr10">{{$arr[$i]}}</span></li>
                        @else
                    ...
                    <div class="table-footer">
                    	<div class="btn-box"><a href="{{ route('checkouts', ['id' => $pl->id, 'type' => 3, 'parameter' => $pl->no_of_parameter ?? '0']) }}" class="book_now">{{__('message.Book Now')}}<i class="icon-Arrow-Right"></i></a></div>
                    	 @if($pl->price > 0 )
...
<section class="blog_section bg-color-3 sec-pad">
  <div class="auto-container">
    ...
    <div class="three-item-carousel owl-carousel owl-theme owl-nav-none m-0">
        @foreach($blogdata as $c)
        <div class="testimonial-block-two">
              <div class="inner-box">
                	<div class="blog_box ">
                    	<div class="blog_img">
                        	<img src="{{asset('storage/app/public/Blog').'/'.$c->image}}" alt="" style="width:98%;height:225px;" />
                        </div>
                        <div class="blog_content p-2">
                            <p style="font-size:12px;">{{substr_replace($c->name, "   ", 45)}}</p>
                            <div class="blog_link" style="margin:8px;"><a class="read_more" href="{{ route('blog_detail', ['slug' => $c->slug]) }}">Know More</a></div>
                            <div class="blog_bottom pb-1" style="font-size:12px;">
    ...
    <!--            	<div class="blog_box ">-->
    <!--                	<div class="blog_img">-->
    <!--                    	<img src="{{asset('storage/app/public/Blog').'/'.$c->image}}" alt="" style="width:100%;height:230px;" />-->
    <!--                    </div>-->
    <!--                    <div class="blog_content p-2">-->
    <!--                        <p>{{substr_replace($c->name, "   ", 130)}}</p>-->
    <!--                        <div class="blog_link"><a class="read_more" href="{{ route('blog_detail', ['slug' => $c->slug]) }}">Know More</a></div>-->
    <!--                        <div class="blog_bottom pb-2">-->
    <!--                        	<div class="author">Reliable</div>-->
    <!--                            <div class="blog_date">-->
    <!--                                {{ \Carbon\Carbon::parse($c->created_at)->format('d M Y') }}-->
    <!--                            </div>-->
