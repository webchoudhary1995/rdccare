  ...
  <style>
    * {
    ...
    body {
      ...
      /* background-image: url("..\assets\images\b2.jpg"class=" img-fluid d-block w-100"id="img1"alt="test"); */
...
<body>
  ...
  <span id="firstbox">
    <div class="container" style="border: none;">
      ...
      <h5 style="display: inline-block;margin: auto;align-items: center;" class="userwelcome">Welcome <span style="color: #0093dd"></span> !</h5>
    </div>
    <form action="javascript:BookAppointment()">
      <center>
      ...
      <div class="container">
        ...
        <div class="container" style="display: grid; grid-gap: 20px;border:2px solid lightgray;">
          <div class="row">
