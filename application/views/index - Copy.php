...
<head>
  ...
  <style>
    body {
      background-image: url(assets/images/themicro5.jpg);
  ...
  <div class="container1 bag">
    ...
    <div class="container drive" id="box">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <form class="row g-3" action="javascript:GlobalLogin()">
              <div class="col-auto">
...
<script>
  function GlobalLogin() {
    ...
    $.ajax({
      cache: false,
      type: "POST",
      url: 'http://www.support.elabassist.com/services/globaluserservice.svc/UserRegistration',
        ...
        if (objresult) {
          ...
          if (objres) {
            if (objres.Result == 'Success') {
              ...
              window.location.href = 'getappointment';
            } else {
